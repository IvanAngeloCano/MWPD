...
<div class="layout-wrapper">
  ...
  <div class="content-wrapper">
    ...
    <main class="main-content">
      <div style="width: 1050px; height: 750px; position: absolute;">
        <div style="width: 800px; margin-top: 10px; height: 350px; display: inline-block;">
          
        <!-- Gender Chart -->
          <div style="width: 390px; height: 350px; display: inline-block; position: absolute; top: 10; left: 0;">
            <canvas id="genderChart" width="380" height="300"></canvas>
          </div>

          <!-- PCT Chart -->
          <div style="width: 390px; height: 350px; display: inline-block; position: absolute; top: 10; left: 400px;">
            <canvas id="pctChart" width="380" height="300"></canvas>
          </div>
        </div>

        <div style="width: 240px; margin-top: 10px; height: 350px; display: inline-block; position: absolute;">
          <div style="width: 240px; height: 175px;">
            <h4>TOTAL REQUESTS</h4>
            <div id="totalRows" style="font-size: 20px; color: black; padding-top: 50px; text-align: center;"></div>
          </div>
          <div style="width: 240px; height: 175px;">
            <h4>NO. RECORD PRINTED/RETRIEVE</h4>
            <div id="totalPrinted" style="font-size: 20px; color: black; padding-top: 50px; text-align: center;"></div>
          </div>
        </div>

        <div style="width: 1050px; margin-top: 10px; height: 370px; position: absolute;">
          <div style="width: 350px; height: 350px; display: inline-block; position: absolute;">
            <h4>PURPOSE</h4>
            <canvas id="purposeChart" width="330" height="300"></canvas>
          </div>
          <div style="width: 350px; height: 350px; display: inline-block; position: absolute; left: 350px;">
            <h4>WORK CATEGORY</h4>
            <canvas id="workCategoryChart" width="330" height="300"></canvas>
          </div>
          <div style="width: 350px; height: 350px; display: inline-block; position: absolute; left: 690px;">
